...
<body>
  ...
  @if(\Session::has('alert'))
    ...
    @csrf
       ...
       <tr data-href= "{{route('makanan', $data->id)}}">
  ...
  <br>
  <a href= "/daftarMakanan/tambahMakanan" style="left:11.4cm; position: absolute;"><button type="button" class="btn btn-primary" style="left: 50%;">Tambah Makanan</button></a>
  </div>
